      ...
      <div style={styles.dashboardContainer}>
        ...
        <div style={styles.statsGrid}>
          <div style={styles.statCard}>
            <div style={{...styles.statIcon, background: 'rgba(167, 246, 111, 0.1)', color: '#A7F66F'}}>👥</div>
            <div>
        ...
        <div style={styles.rowLayout}>
          <div style={styles.card}>
            ...
            <div style={styles.progressItem}>
              ...
              <div style={styles.progressTrack}><div style={{...styles.progressBar, width: '85%', background: '#A7F66F'}}></div></div>
            </div>
            <div style={styles.progressItem}>
    ...
    <div style={styles.layout}>
      ...
      <div style={{
        ...
        <nav style={styles.nav}>
          ...
          <button onClick={() => changeView('reports')} style={view === 'reports' ? styles.navActive : styles.navItem}>📊 Reports</button>
          <button onClick={() => changeView('audit')} style={view === 'audit' ? styles.navActive : styles.navItem}>🕵️ Audit Logs</button>
          <button onClick={() => changeView('users')} style={view === 'users' ? styles.navActive : styles.navItem}>👤 User Management</button>
...
const styles = {
  layout: {
    ...
    backgroundImage: 'radial-gradient(circle at 10% 20%, rgba(167, 246, 111, 0.05) 0%, transparent 20%), radial-gradient(circle at 90% 80%, rgba(212, 175, 55, 0.05) 0%, transparent 20%)',
    color: '#e6f1ff',
  ...
  mobileHeader: {
    ...
    zIndex: 1000,
    borderBottom: '1px solid rgba(167, 246, 111, 0.1)',
  },
  hamburger: { background: 'none', border: 'none', color: '#A7F66F', fontSize: '24px', cursor: 'pointer' },
  mobileTitle: { margin: 0, fontSize: '20px', fontWeight: 'bold', color: '#A7F66F' },
  ...
  sidebar: {
    ...
    borderRight: '1px solid rgba(167, 246, 111, 0.1)',
    display: 'flex',
  ...
  sidebarTitle: { margin: 0, fontSize: '28px', fontWeight: '800', background: 'linear-gradient(90deg, #A7F66F, #D4AF37)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' },
  ...
  navActive: { textAlign: 'left', padding: '15px', background: 'linear-gradient(90deg, rgba(167, 246, 111, 0.1), rgba(167, 246, 111, 0.05))', color: '#A7F66F', border: '1px solid rgba(167, 246, 111, 0.2)', borderRadius: '8px', cursor: 'pointer', fontSize: '15px', fontWeight: 'bold', boxShadow: '0 4px 6px rgba(0,0,0,0.3)' },
  ...
  desktopHeader: { display: window.innerWidth <= 768 ? 'none' : 'flex', height: '80px', alignItems: 'center', padding: '0 40px', backgroundColor: 'rgba(17, 34, 64, 0.5)', backdropFilter: 'blur(10px)', borderBottom: '1px solid rgba(167, 246, 111, 0.1)' },
  ...
  welcomeBanner: { 
    background: 'linear-gradient(90deg, rgba(167, 246, 111, 0.1), rgba(17, 34, 64, 0.6))', 
    padding: '30px', borderRadius: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', 
    marginBottom: '30px', border: '1px solid rgba(167, 246, 111, 0.2)', boxShadow: '0 10px 30px rgba(0,0,0,0.3)' 
  },
  bannerTitle: { margin: 0, fontSize: '28px', color: '#A7F66F' },
  ...
  statCard: { backgroundColor: 'rgba(17, 34, 64, 0.6)', padding: '20px', borderRadius: '16px', border: '1px solid rgba(167, 246, 111, 0.1)', boxShadow: '0 10px 30px rgba(0,0,0,0.3)', display: 'flex', alignItems: 'center', gap: '15px' },
  ...
  card: { backgroundColor: 'rgba(17, 34, 64, 0.6)', backdropFilter: 'blur(12px)', padding: '25px', borderRadius: '16px', boxShadow: '0 10px 30px rgba(0,0,0,0.3)', border: '1px solid rgba(167, 246, 111, 0.1)' },
  cardTitle: { margin: 0, fontSize: '18px', color: '#e6f1ff' },
  separator: { height: '2px', background: 'linear-gradient(90deg, transparent, rgba(167, 246, 111, 0.5), transparent)', margin: '15px 0', boxShadow: '0 0 10px rgba(167, 246, 111, 0.3)' },
  ...
  td: { padding: '12px 10px', color: '#e6f1ff', fontSize: '14px', borderBottom: '1px solid rgba(167, 246, 111, 0.1)' },
